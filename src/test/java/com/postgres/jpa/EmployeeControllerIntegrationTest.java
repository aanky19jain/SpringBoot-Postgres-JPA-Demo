...
public class EmployeeControllerIntegrationTest {
	...
	public void testGetAllEmployees() {
		...
		ResponseEntity<String> response = restTemplate.exchange(getRootUrl() + "/v1/employees", HttpMethod.GET, entity,
				String.class);
	...
	public void testGetEmployeeById() {
		Employee employee = restTemplate.getForObject(getRootUrl() + "/v1/employees/1", Employee.class);
	...
	public void testCreateEmployee() {
		...
		ResponseEntity<Employee> postResponse = restTemplate.postForEntity(getRootUrl() + "/v1/employees", employee,
				Employee.class);
